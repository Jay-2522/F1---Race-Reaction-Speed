                ...
                <div>
                  ...
                  <div className="flex items-center justify-center gap-4">
                    <Button
                      ...
                      onClick={() => updateSettings({ numberOfDrivers: Math.max(1, settings.numberOfDrivers - 1) })}
                    ...
                    <Button
                      variant="outline"
                      className="border-[#27272a] text-white hover:bg-[#27272a] h-10 w-10 p-0"
                      onClick={() => updateSettings({ numberOfDrivers: Math.min(10, settings.numberOfDrivers + 1) })}
